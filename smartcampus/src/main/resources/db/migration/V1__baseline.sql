...
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (1, 'Main Hall A', 'Large lecture hall with projector and sound system', 'LECTURE_HALL', 'Building A, Floor 1', 'AVAILABLE', false, 200, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (2, 'Computer Lab 3', '30 workstations with development tools installed', 'LAB', 'Building B, Floor 2', 'AVAILABLE', false, 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (3, 'Meeting Room C', 'Small meeting room with whiteboard and video conferencing', 'MEETING_ROOM', 'Building A, Floor 3', 'AVAILABLE', false, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (4, 'Science Lab 1', 'Chemistry lab with fume hoods and safety equipment', 'LAB', 'Building C, Floor 1', 'AVAILABLE', false, 25, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (5, 'Seminar Room D', 'Medium seminar room with smart board', 'MEETING_ROOM', 'Building A, Floor 2', 'AVAILABLE', false, 40, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (6, 'Projector Kit #1', 'Portable projector with HDMI and wireless casting', 'LAB', 'Equipment Room, Floor 1', 'AVAILABLE', false, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (7, 'Conference Room E', 'Executive conference room with video wall', 'MEETING_ROOM', 'Building D, Floor 1', 'AVAILABLE', false, 20, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (8, 'Workshop Space F', 'Open workshop area with tools and workbenches', 'LAB', 'Building C, Floor 2', 'AVAILABLE', false, 15, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (9, 'Audio Visual Kit #2', 'Portable PA system with wireless microphones', 'LAB', 'Equipment Room, Floor 1', 'AVAILABLE', false, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, created_at, updated_at) VALUES (10, 'Lecture Hall B', 'Tiered lecture hall with dual projectors', 'LECTURE_HALL', 'Building B, Floor 1', 'OUT_OF_SERVICE', false, 150, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
