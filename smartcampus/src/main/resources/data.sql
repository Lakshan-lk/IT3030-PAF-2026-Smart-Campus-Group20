...
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, image_url, created_at, updated_at) VALUES (2, 'Computer Lab 3', '30 workstations with development tools installed', 'LAB', 'Building B, Floor 2', 'AVAILABLE', false, 30, '/images/facilities/lab.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING;
...
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, image_url, created_at, updated_at) VALUES (4, 'Science Lab 1', 'Chemistry lab with fume hoods and safety equipment', 'LAB', 'Building C, Floor 1', 'AVAILABLE', false, 25, '/images/facilities/lab.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING;
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, image_url, created_at, updated_at) VALUES (5, 'Seminar Room D', 'Medium seminar room with smart board', 'MEETING_ROOM', 'Building A, Floor 2', 'AVAILABLE', false, 40, '/images/facilities/meeting-room.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING;
...
INSERT INTO resources (id, name, description, type, location, status, is_deleted, capacity, image_url, created_at, updated_at) VALUES (8, 'Workshop Space F', 'Open workshop area with tools and workbenches', 'LAB', 'Building C, Floor 2', 'AVAILABLE', false, 15, '/images/facilities/workshop.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING;
