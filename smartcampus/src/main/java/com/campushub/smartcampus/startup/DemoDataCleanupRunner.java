...
public class DemoDataCleanupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        deleteInOrder("equipment", "id", List.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, 15L, 16L, 17L, 18L, 19L, 20L, 21L, 22L, 23L, 24L));
        deleteInOrder("resources", "id", List.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L));
    ...
    private boolean tableExists(String tableName) {
        return Boolean.TRUE.equals(jdbcTemplate.execute(connection -> {
            ...
            try (var rs = meta.getTables(null, "public", tableName, new String[] { "TABLE" })) {
                return rs.next();
            }
        }));
    }
