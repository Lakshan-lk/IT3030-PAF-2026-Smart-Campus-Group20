...
import { useEquipmentBookings, useApproveEquipmentBooking, useRejectEquipmentBooking, useCancelEquipmentBooking } from '../hooks/useEquipmentBookings';
...
const COLS = ['Equipment', 'User', 'Purpose', 'Date & Time', 'Status', 'Actions'];

const AdminEquipmentBookingsPage = () => {
  ...
  const filtered = bookings
    ...
    .filter(b => {
      ...
      return b.equipmentName?.toLowerCase().includes(q) ||
                      ...
                      >
                        ...
                        <td style={{ padding: '13px 16px', verticalAlign: 'middle' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            ...
                            <div>
                              <p style={{ fontSize: 14, fontWeight: 600, color: '#f1f5f9', whiteSpace: 'nowrap' }}>{booking.equipmentName}</p>
...
export default AdminEquipmentBookingsPage;
